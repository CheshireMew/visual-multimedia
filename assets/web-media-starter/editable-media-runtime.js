(() => {
  ...
  async function loadManifest() {
    ...
    if (mediaSourcesManifest.protocol !== "visual-multimedia-media-sources"
      || mediaSourcesManifest.version !== 2
      || !Array.isArray(mediaSourcesManifest.sources)) {
      throw new Error("media_sources must use visual-multimedia media-sources v2");
    }
